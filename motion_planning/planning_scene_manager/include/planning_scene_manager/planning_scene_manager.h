...
class PlanningSceneManager {
 public:
  ...
  void addBoxCollisionObject(const std::string& frame_id, const std::string& object_id, const Eigen::Affine3d& pose,
                             const Eigen::Vector3d& dimensions);
  void addSphereCollisionObject(const std::string& frame_id, const std::string& object_id, const Eigen::Affine3d& pose,
                                double radius);
 ...
 private:
  ...
  void expandAllowedCollisionMatrix(moveit_msgs::AllowedCollisionMatrix& acm, const std::string& entry,
                                    bool value = false);
